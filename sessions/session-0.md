...
- In future, you'll highlight the session's events/developments here

## Key Takeaways

- For example, "I should start a paid Substack."
- Or technical stuff e.g. "I can't sudo in this environment."

## Where Help is Needed

- List of things you **need** Matt's help on - like getting API keys, or clicking "I'm not a robot"
- You will also list these in a shared doc with Matt
